    ...
    class Program
    {
        ...
        static void Tikrinti(string rez, ref string text1, string text2, char[] skyrikliai)
        {
            ...
            foreach (string zodis1 in parts1)
            {
                ...
                //foreach (string zodis2 in parts2)
                //{
                //    if (zodis1.ToLower() == zodis2.ToLower() && zodis2.ToLower() == pagalb.ToLower())
                //    {
                //        Console.WriteLine(zodis1 + " " + zodis2);
                //        Spausdinti(rez, string.Format("{0}", text1.Substring(0, text1.IndexOf(zodis2.ToLower()))));
                //        text1 = text1.Substring(text1.IndexOf(zodis2.ToLower()));
                //        pagalb = text1.Split(skyrikliai, StringSplitOptions.RemoveEmptyEntries)[0];
                //        break;
                //    }
                //}
        }
