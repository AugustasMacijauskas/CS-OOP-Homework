...
namespace Klases1
{
    class Siena
    {
        ...
        public Siena(double ilgis, double aukstis)
        {
            ...
            Console.WriteLine("Plytos ilgis: " + this.ilgis + ";\nPlytos aukstis: " + this.aukstis);
        }
    ...
    class Program
    {
        ...
        static double skaiciuoti(Plyta p, Siena s1, Siena s2, Siena s3, Siena s4)
        {
        ...
        static void Main(string[] args)
        {
            ...
            kiekPirmuPlytu = skaiciuoti(p1, s1, s2, s3, s4);
            kiekAntruPlytu = skaiciuoti(p2, s1, s2, s3, s4);
