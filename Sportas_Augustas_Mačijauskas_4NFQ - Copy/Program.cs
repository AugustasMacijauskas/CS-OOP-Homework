...
namespace Sportas
{
    abstract class Sportininkas : IComparable<Sportininkas>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is Futbolininkas && this is Futbolininkas)
            {
                Console.WriteLine("Fut");
                return ((Futbolininkas)this).Equals(obj);
            }
            if (obj is Krepšininkas && this is Krepšininkas)
            {
                Console.WriteLine("Kre");
                return ((Krepšininkas)this).Equals(obj);
            }
    ...
    class Krepšininkas : Sportininkas, IComparable<Krepšininkas>
    {
        ...
        public override bool Equals(object obj)
        {
            if (obj is Krepšininkas)
            {
                return this.Pavardė == ((Krepšininkas)obj).Pavardė && this.Vardas == ((Krepšininkas)obj).Vardas && this.Komanda == ((Krepšininkas)obj).Komanda;
            }
    ...
    class Futbolininkas : Sportininkas, IComparable<Futbolininkas>
    {
        ...
        public override bool Equals(object obj)
        {
            if (obj is Futbolininkas)
            {
                return this.Pavardė == ((Futbolininkas)obj).Pavardė && this.Vardas == ((Futbolininkas)obj).Vardas && this.Komanda == ((Futbolininkas)obj).Komanda;
            }
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ArVienodi(sportininkai);

            Console.WriteLine("Programa baigė darbą!");
        }

        static void ArVienodi(List<Sportininkas> naujas)
        {
            for (int i = 0; i < naujas.Count - 1; i++)
            {
                for (int j = i + 1; j < naujas.Count; j++)
                {
                    if (naujas[i].Equals(naujas[j]))
                    {
                        Console.WriteLine("Vienodi pozicijose {0} ir {1}", i, j);
                    }
                }
            }
        }

        static void Rikiuoti(List<Sportininkas> A)
        {
            int minIndex;
