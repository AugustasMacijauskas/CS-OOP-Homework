...
namespace Labaratorinis_U2_2
{
    ...
    class Liftas
    {
        ...
        public int DidintiGalia(int x)
        {
            galia *= x;
            return galia;
        }

        public int DidintiTalpa(int x)
        {
            talpa *= x;
            return talpa;
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int visuStudentuSvoris = 0;

            for (int i = 0; i < studentai.Length; i++)
            {
                visuStudentuSvoris += studentai[i].koksSvoris();
            }
            ...
            Console.WriteLine("Vidutinis studentu svoris:      {0,5:d} k.", visuStudentuSvoris / kiekStudentu);
            Console.WriteLine("");
        }
